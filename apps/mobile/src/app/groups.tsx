...
export default function GroupsScreen() {
  return (
    <LedgerScreen>
      <View>
        <Text style={styles.eyebrow}>ENTRY GROUPS</Text>
        <Text style={styles.title}>Related spending, together.</Text>
        <Text style={styles.copy}>
          Groups retain every individual entry while keeping a larger event
          understandable.
        </Text>
      </View>
          ...
          <GlassSurface key={group.id}>
            <View style={styles.row}>
              <View style={styles.copyBlock}>
                <Text style={styles.groupType}>EXPENSE GROUP</Text>
              ...
              <View style={styles.amountBlock}>
                <Text style={styles.groupAmount}>{currency(group.total)}</Text>
