  ...
  return (
    <LedgerScreen>
      <View>
        ...
        <Text style={styles.title}>Make the month visible.</Text>
        <Text style={styles.copy}>
          A clear view of income, spending, and the net you have left to direct.
        </Text>
      </View>
      ...
      <GlassSurface>
        <View style={styles.rowBetween}>
          <View>
            ...
            <Text style={styles.sectionCopy}>Latest ledger entries</Text>
          </View>
          <Text style={styles.link}>Ledger</Text>
        </View>
