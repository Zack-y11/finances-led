  ...
  return (
    <LedgerScreen>
      <View>
        ...
        <Text style={styles.title}>Capture it while it is fresh.</Text>
        <Text style={styles.copy}>
          Turn a short note into a reviewable ledger proposal.
        </Text>
      </View>
      <GlassSurface>
        ...
        <Pressable
          ...
          style={[styles.button, !note.trim() && styles.disabled]}
        >
          <Text style={styles.buttonText}>Interpret entry →</Text>
        </Pressable>
      </GlassSurface>
      {showProposal ? (
        <GlassSurface>
          <Text style={styles.proposalLabel}>PROPOSAL PREVIEW</Text>
          <Text style={styles.proposalTitle}>Dining expense · $3.19</Text>
